    ...
    public void sendEvent(String name, ReadableMap data, String scope) {
        ...
        if (method != null) {
            try {
                ...
                // FIXME the IDE complains about "reflective exception" and min
                // KITKAT API level 19 required to be able to catch both in
                // a single block, but the current min level is 16.
